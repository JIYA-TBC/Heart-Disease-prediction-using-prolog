...
pulmonary_hypertension(Patient) :-
...
peripheral_arterial_disease(Patient) :-
  symptom(Patient, st_depression, StDepression),
...
coronary_artery_disease(Patient) :-
  symptom(Patient, st_slope, StSlope),
